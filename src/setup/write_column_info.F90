...
! ----------------------------------------------------------------------------
  ...
  do k=1,BDIM
     call add_vector_column_info(unitno,ncolumns,k,"B","magnetic field")
  end do
#endif
#if defined(IDEAL_MHD) && defined(INDUCTION_EQN) && defined(HYDRO)
  do k=1,BDIM
     call add_vector_column_info(unitno,ncolumns,k,"dB_dt","Rate of change of B")
  end do
#endif
#if defined(IDEAL_MHD) && defined(DEBUG_MHD) && defined(HYDRO)
  call add_scalar_column_info(unitno,ncolumns,"div_B","magnetic field divergence")
#endif
  do k=1,VDIM
...
#if defined(IDEAL_MHD) && defined(HYDRO)
  do k=1,VDIM
     call add_vector_column_info(unitno,ncolumns,k,"a_mag","magnetic accel.")
  end do
#endif
...
!  do k=1,NDIM
!     call add_vector_column_info(unitno,ncolumns,k,"gradrho")
!  end do
!#endif
#if defined(HYDRO)
...
#endif
  call add_scalar_column_info(unitno,ncolumns,"drhodt","rate of change of rho")
...
! ----------------------------------------------------------------------------
  ...
  call add_scalar_column_info(unitno,ncolumns,"nsteps","total step no's at formation")
