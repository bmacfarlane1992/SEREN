...
! Time variables
  ...
  call add_long_integer_parameter("ndiagstep",ndiagstep,16_ILP)
  call add_long_integer_parameter("nsinkstep",nsinkstep,16_ILP)
...
! Sink accretion and feedback parameters parameters
  ...
  call add_double_parameter("smooth_accrete_frac",smooth_accrete_frac,5.0E-3_DP)
