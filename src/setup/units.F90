...
!  write(6,*) "Sound constant         = ", sound_const*vscale, vunit
!  write(6,*) "New sound constant     = ", newsound_const*vscale, vunit
!  write(6,*) "Pressure constant      = ", Pconst
!  write(6,*) "rad_const              = ", rad_const
!  write(6,*) "intmax                 = ", intmax
  write(6,*) "sound speed @ 10K      = ", sqrt(Pconst*10.0_DP)*vscale
#endif
