...
100 write(1,'(60E18.10)') time*tscale, mtot_temp*mscale,&
         ...
         &force(1:VDIM), force_grav(1:VDIM), gpetot*Escale, ketot*Escale, &
         & etot*Escale
  close(1)
#else
100 write(1,'(60E18.10)') time*tscale, mtot_temp*mscale, rcom_temp(1:NDIM)*rscale, &
       & vcom_temp(1:VDIM)*vscale, mom(1:VDIM)*momscale, angmom(1:3)*angmomscale, &
